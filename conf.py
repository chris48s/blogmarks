...
BLOG_AUTHOR = "chris48s"  # (translatable)
BLOG_TITLE = "Blogmarks"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://chris48s.github.io/blogmarks/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://chris48s.github.io/blogmarks/"
BLOG_EMAIL = "hello@chris-shaw.dev"
BLOG_DESCRIPTION = "Handy links or snippets, and a sentence or two"  # (translatable)
